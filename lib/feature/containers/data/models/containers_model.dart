...
class ContainerModel extends Equatable {
  ...
  factory ContainerModel.fromMap(Map<String, dynamic> map) {
    return ContainerModel(
      ...
      arrivalDate: map['arrivalDate'] != null
          ...
          : null,
      containerStatus: ContainerStatus.fromMap(map['containerStatus']),
  ...
  @override
  String toString() {
    return 'ContainerModel(date: $date, acceptedDate: $acceptedDate, shippingDate: $shippingDate, arrivalDate: $arrivalDate, containerStatus: $containerStatus, containerTypeName: $containerTypeName, containerTypeId: $containerTypeId, number: $number, description: $description, awbNumber: $awbNumber, line: $line, faxNumber: $faxNumber, originCountryName: $originCountryName, originCountryId: $originCountryId, destinationCountryName: $destinationCountryName, destinationCountryId: $destinationCountryId, attachment: $attachment, note: $note, id: $id)';
  }
