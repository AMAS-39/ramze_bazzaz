...
class PayInsteadsScreen extends StatefulWidget {
  const PayInsteadsScreen({super.key, required this.filterController});
  final PayInsteadsFilterModel filterController;
  @override
  State<PayInsteadsScreen> createState() => _PayInsteadsScreenState();
}

class _PayInsteadsScreenState extends State<PayInsteadsScreen> {
    ...
    return BlocProvider(
      ...
      child: Scaffold(
        appBar: appConfig.app == App.rbb
            ? null
            : AppBar(title: Text(Trans.payInsteads.trans())),
        body: Column(
          children: [
                ...
                if (status is PayInsteadsLoadedState) {
                  ...
                  totalY = status.data.fold(
                      ...
                      (previousValue, element) =>
                          previousValue + element.totalTransferAmount);
