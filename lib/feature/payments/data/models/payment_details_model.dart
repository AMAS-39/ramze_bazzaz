...
class PaymentDetailsModel extends Equatable {
  ...
  String get priceText {
    if (sl<LocalAppSettingsCubit>().state.lang == LanguageEnum.ar) {
      return arPriceText;
    } else if (sl<LocalAppSettingsCubit>().state.lang == LanguageEnum.ku) {
      return kuPriceText;
    } else {
      return enPriceText;
    }
  ...
  factory PaymentDetailsModel.fromMap(Map<String, dynamic> json) =>
      PaymentDetailsModel(
        id: json["id"],
        note: json["note"],
        ...
        attachment: formatAttachment(json["attachment"]),
